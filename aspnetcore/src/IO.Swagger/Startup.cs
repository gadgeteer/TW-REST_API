    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("0.3.4-oas3", new Info
                    {
                        Version = "0.3.4-oas3",
                        Title = "ThingWorx Core REST API",
                        Description = "ThingWorx Core REST API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/0.3.4-oas3/swagger.json", "ThingWorx Core REST API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "ThingWorx Core REST API Original");
                });
